import { kpiData } from "@/data/taxiData";

const cards = [
  { label: "Total Trips", value: kpiData.totalTrips, bg: "postit-yellow", rotation: "rotate(-2.5deg)", decoration: "tape", offset: "0px" },
  { label: "Total Revenue", value: kpiData.totalRevenue, bg: "postit-white", rotation: "rotate(1.8deg)", decoration: "pin", offset: "8px" },
  { label: "Avg Fare", value: kpiData.avgFare, bg: "postit-blue", rotation: "rotate(-1deg)", decoration: "tape-left", offset: "-5px" },
  { label: "Tip Rate", value: kpiData.tipRate, bg: "postit-pink", rotation: "rotate(2.5deg)", decoration: "pin", offset: "12px" },
];
    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
      {cards.map((card, i) => (
        ...
        >
          ...
          {/* Small doodle arrow on first card */}
          {i === 0 && (
